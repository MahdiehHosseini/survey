            ...
            <div className=' shadow-sm shadow-gray-200 text-right bg-white/50 p-6'>
                <div className='flex justify-between mt-14 mb-6 items-center'>
                    <span className='flex flex-row '>
                        <button onClick={() => dispatch(deleteSurvey(survey.Id))}><i className=' material-icons text-2xl text-custom-red px-2 py-1 rounded-md border border-custom-red'>delete</i></button>
                        <Link to='setting'><i className=' material-icons ml-3 text-2xl text-custom-green px-2 py-1 rounded-lg border border-custom-green'>edit</i></Link>
                    </span>
