  ...
  return (
        <div className='px-10 py-5 shadow-sm shadow-gray-300 bg-white/50  mb-6'>
            <span className='flex justify-between my-10'>
                <button onClick={() => dispatch(toggle('addQuestion'))} className='text-white bg-custom-green rounded-lg px-5 py-2 text-lg'>افزودن سوال</button>
                <h5 className=' text-2xl text-custom-green'>لیست سوالات</h5>
            </span>
