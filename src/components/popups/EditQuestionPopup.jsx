  ...
  return (
    <span className='h-screen w-screen top-0 absolute z-10 flex justify-center items-center bg-black/50'>
        <div className=' bg-white rounded-2xl p-10 z-20 absolute items-center flex flex-col h-3/5 w-1/4'>
            ...
            <form onSubmit={() => dispatch(editQuestion({ Title: questionTitle, Options: [] }))} className=' flex flex-col items-center'>
                    ...
                    <span className='flex justify-between w-full items-center'>
                      ...
                      <button type='submit' className=' text-white bg-custom-green rounded-lg px-12 py-4 text-sm my-14'>ویرایش</button>
                    </span>
            </form>
        </div>
    </span>
