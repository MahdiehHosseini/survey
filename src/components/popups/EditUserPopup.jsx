...
function EditUserPopup () {
  ...
  return (
    <span className='h-screen w-screen top-0 absolute z-10 flex justify-center items-center bg-black/50'>
        <div className=' bg-white rounded-2xl p-10 z-20 absolute items-center flex flex-col h-2/3 w-1/2'>
            <h5 className=' text-center text-xl text-custom-green mt-6 mb-5'>افزودن کاربر</h5>
            <form onSubmit={() => dispatch(addUser({ UserName: userName, CreatedDate: new Date(), Password: password, Address: address, FullName: fullName, PhoneNumber: phoneNumber }))} >
                <span className='flex items-center my-4 justify-end'>
                    ...
                    <p className='text-lg'>دسترسی ادمین</p>
                </span>
                <div className=' flex items-center justify-between w-full'>
                    <span className='flex flex-col w-full mr-10'>
                        ...
                        <span className='flex flex-col text-right text-lg my-7'>
                ...
                <span className='flex flex-col h-24 text-right text-lg w-full mr-10'>
                ...
                <span className='flex justify-between w-full items-center px-16 mt-10'>
                    <button type='button' onClick={() => dispatch(toggle('none'))} className=' text-white bg-custom-red rounded-lg px-12 py-4 text-lg'>لغو</button>
                    <button type='submit' className=' text-white bg-custom-green rounded-lg px-12 py-4 text-lg'>ویرایش</button>
                </span>
            </form>
        </div>
    </span>
